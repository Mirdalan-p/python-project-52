...
class SimpleTestCase(TestCase):
    ...
    url_create_status = reverse_lazy('create_status')
    url_update_status = reverse_lazy('status_update', kwargs={"pk": 1})
    url_delete_status = reverse_lazy('status_delete', kwargs={"pk": 1})
    ...
    def test_status_create(self):
        ...
        self.client.post(self.url_create_status, data = {'name': 'first status'})
    ...
    def test_status_update(self):
        self.client.post(self.url_login, data=First_user)
        self.client.post(self.url_create_status, data = {'name': 'first status'})
        self.client.post(self.url_update_status, data = {'name': 'second status'})
        response = self.client.get('/statuses/')
